...
if($widget.options.enableControlLabel){var classContainer='';var elemenStockAvailability='';if(item.code==='talle'){classContainer='container-stock-availability';elemenStockAvailability=$('#stock-availability-widget');elemenStockAvailability=elemenStockAvailability.length===0?'':elemenStockAvailability[0].innerHTML;}
label+='<div class="'+classContainer+'">'+'<span id="'+controlLabelId+'" class="'+classes.attributeLabelClass+'">'+
$('<i></i>').text(item.label).html()+'</span>'+'<span class="'+classes.attributeSelectedOptionLabelClass+'"></span>'+
elemenStockAvailability+'</div>';}
...
$input.trigger('change');if($widget.inProductList&&$this.closest('.swatch-attribute').data('attribute-code')=='talle'){$widget.productForm.submit();}},_getSelectedOptionPriceIndex:function(){var allowedProduct=this._getAllowedProductWithMinPrice(this._CalcProducts());if(_.isEmpty(allowedProduct)){return undefined;}
